...
public class LoginWindow extends JFrame implements KeyListener{
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        boolean loggedIn = Main.attemptLogin(jTextField1.getText(), jPasswordField1.getPassword());
        if(loggedIn){
            this.setVisible(false);
            Main.login();
        }else{
            JOptionPane.showMessageDialog(this, "Failed Login Attempt");
        }
